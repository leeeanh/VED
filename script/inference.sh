...
CUDA_VISIBLE_DEVICES=$GPUS python3 main.py --project_path $project_path --cfg_folder $cfg_folder --cfg_name $config --verbose $verbose  --inference --inference_model $inference_model\
