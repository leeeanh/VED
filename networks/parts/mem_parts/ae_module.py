...
class Encoder(nn.Module):
    def __init__(self, t_length=5, n_channels=3):
        ...
        def Basic(intInput, intOutput):
            return torch.nn.Sequential(
                torch.nn.Conv2d(in_channels=intInput,
                                ...
                                kernel_size=3,
                                stride=1,
                                padding=1), torch.nn.BatchNorm2d(intOutput),
        ...
        self.moduleConv1 = Basic(n_channels * t_length, 64)
...
class Decoder(torch.nn.Module):
    def __init__(self, t_length=5, n_channels=3, networks_type= 'appearance'):
        ...
        def Gen(intInput, intOutput, nc):
            return torch.nn.Sequential(
                torch.nn.Conv2d(in_channels=intInput,
                                ...
                                kernel_size=3,
                                stride=1,
                                padding=1), torch.nn.BatchNorm2d(nc),
                torch.nn.ReLU(inplace=False),
